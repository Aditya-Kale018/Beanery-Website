...
const MAP_BOUNDS = '73.8187%2C18.5327%2C73.8408%2C18.5448';
  ...
  return (
    <div style={st('position:absolute;inset:0;overflow:hidden;background:#EFE3D8')}>
      <iframe
        ...
        style={st('width:100%;height:100%;display:block;border:0;filter:grayscale(.8) sepia(.25) saturate(.82) contrast(.92) brightness(1.04)')}
      />
