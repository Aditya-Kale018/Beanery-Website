...
export default class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      {menuOpen && (
        <>
          <div style={st("position:fixed;inset:0;z-index:150;background:#FBF8F4;display:flex;flex-direction:column;padding:26px 24px 40px")}>
        ...
        <>
          <div>
            ...
            <section style={st("padding:120px 0 130px;background:#5E2B17;color:#FBF8F4;overflow:hidden")}>
              ...
              <div data-reveal="60" ref={railRefSig} style={st("display:flex;gap:26px;overflow-x:auto;scroll-snap-type:x mandatory;padding:52px 40px 12px;max-width:1640px;margin:0 auto")}>
                {signature.map((s, i) => (
            ...
            <section style={st("background:#EFE3D8;display:grid;grid-template-columns:1.1fr 1fr;align-items:stretch")}>
              ...
              <div style={st("position:relative;overflow:hidden;background:#DFCBB9;min-height:600px")}>
                <div style={st("position:absolute;inset:0")}>
                  <ImageSlot id="map-home" placeholder="Map placeholder — Senapati Bapat Road, Pune (muted cream map styling)" />
                </div>
        ...
        <>
          <div>
            ...
            <section style={st("padding:120px 0;background:#5E2B17;color:#FBF8F4")}>
              ...
              <div data-reveal="60" ref={railRefBrew} style={st("display:flex;gap:24px;overflow-x:auto;scroll-snap-type:x mandatory;padding:48px 40px 14px;max-width:1640px;margin:0 auto")}>
                {brews.map((b, i) => (
        ...
        <>
          <div>
            ...
            <section style={st("padding:80px 0 120px;background:#FBF8F4")}>
              ...
              <div data-reveal="60" ref={railRefExp} style={st("display:flex;gap:24px;overflow-x:auto;scroll-snap-type:x mandatory;padding:44px 40px 14px;max-width:1640px;margin:0 auto")}>
            ...
            <section style={st("padding:146px 40px 0;background:#FBF8F4")}>
              <div style={st("max-width:1560px;margin:0 auto")}>
                ...
                <div data-reveal="140" style={st("margin-top:60px;overflow:hidden;height:56vh;min-height:400px;background:#DFCBB9;position:relative")}>
                  <div style={st("position:absolute;inset:0")}>
                    <ImageSlot id="map-visit" placeholder="Map: Senapati Bapat Road, Pune — muted cream cartography, marker beside Chaturshrungi Temple" />
                  </div>
      ...
      {reserveOpen && (
        <>
          <div style={st("position:fixed;inset:0;z-index:200;background:rgba(94,43,23,.62);display:flex;align-items:center;justify-content:center;padding:32px")} onClick={closeReserve}>
            <div style={st("background:#FBF8F4;max-width:620px;width:100%;padding:52px 48px;position:relative")}>
              ...
              <p style={st("font-size:14.5px;line-height:1.8;color:#6E4A34;margin-top:14px;max-width:44ch")}>
                Tell us when, and we'll confirm by message within the hour. For groups over twelve, call the café directly.
              </p>
              <div style={st("display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:30px")}>
                <div>
                  <div style={st("font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#96755C;margin-bottom:8px")}>
                    Name
                  </div>
                  <div style={st("border:1px solid rgba(94,43,23,.22);padding:14px 16px;font-size:14px;color:#A9866B")}>
                    Your name
                  </div>
                </div>
                <div>
              ...
              <button className="hv2" onClick={closeReserve} style={st("margin-top:26px;width:100%;text-align:left;font-size:11.5px;letter-spacing:.15em;text-transform:uppercase;font-weight:500;color:#FBF8F4;background:#5E2B17;border:none;padding:19px 26px;cursor:pointer;transition:background .35s ease")}>
                Request reservation
              </button>
              <div style={st("font-size:11.5px;color:#96755C;margin-top:16px")}>
